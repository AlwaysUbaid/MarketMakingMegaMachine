...
class UethMarketMaking(TradingStrategy):
    """
    UETH Market Making Strategy
    ...
    # Strategy metadata
    STRATEGY_NAME = "UETH Market Making"
    ...
    def _run_strategy(self):
        ...
        while self.running and not self.stop_requested:
            try:
                ...
                # Rest of the existing strategy code...
                # ... existing code ...
        ...
        self.logger.info(f"Stopping {self.STRATEGY_NAME} strategy")
