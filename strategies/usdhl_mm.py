...
class UsdhlMarketMaking(TradingStrategy):
    ...
    Since USDHL is a stablecoin, spreads are kept neutral.
    """
    
    # Strategy metadata
    STRATEGY_NAME = "USDHL Market Making"
    STRATEGY_DESCRIPTION = "Places buy and sell orders around the mid price to earn the spread (stablecoin optimized)"
    ...
    STRATEGY_PARAMS = {
        ...
        "bid_spread": {
            "value": 0.0001,  # 0.01% - tighter spread for stablecoin
            "type": "float",
        ...
        "order_amount": {
            "value": 11,  # Larger order size for stablecoin
            "type": "float",
